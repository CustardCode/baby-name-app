...
LANDING_PAGE_DEFINITIONS: list[dict[str, str]] = [
    {
        ...
        "intro": "Sweet, friendly baby girl names with Australian popularity data, ranking movement and profile links.",
    ...
    },
    {
        ...
        "intro": "Friendly baby boy names that feel warm and easy to say, with Australian ranking context.",
    ...
    },
    {
        ...
        "intro": "Girl names that appear in the Australian ranking data but currently sit away from the very top.",
    ...
    },
    {
        ...
        "intro": "Boy names that are recognised in the Australian data without feeling like the most obvious top-list picks.",
    ...
    },
    {
        ...
        "intro": "Established girl names with a classic or old-fashioned feel, paired with current Australian ranking context.",
    ...
    },
    {
        ...
        "intro": "Established boy names with a classic or old-fashioned feel, paired with current Australian ranking context.",
    ...
    },
    {
        ...
        "intro": "Simple 3 to 5 letter girl names with Australian popularity and ranking-history links.",
    ...
    },
    {
        ...
        "intro": "Simple 3 to 5 letter boy names with Australian popularity and ranking-history links.",
    ...
    },
    {
        ...
        "intro": "Girl names with nature-style meaning, imagery or usage notes, backed by Australian ranking data where available.",
    ...
    },
    {
        ...
        "intro": "Boy names with nature-style meaning, imagery or usage notes, backed by Australian ranking data where available.",
    ...
    },
    {
        ...
        "intro": "Girl names currently visible in Australian popularity data, without claiming the names originated in Australia.",
    ...
    },
    {
        ...
        "intro": "Boy names currently visible in Australian popularity data, without claiming the names originated in Australia.",
    ...
    },
    {
        ...
        "intro": "Girl names that have moved upward across recent Australian ranking data.",
    ...
    },
    {
        ...
        "intro": "Boy names that have moved upward across recent Australian ranking data.",
    ...
    },
    {
        ...
        "intro": "Recognised girl names that appear in the data but currently rank lower than the most common picks.",
    ...
    },
    {
        ...
        "intro": "Recognised boy names that appear in the data but currently rank lower than the most common picks.",
    ...
    },
    {
        ...
        "intro": "Girl names from the latest Australian top 100 that currently sit outside the top 50.",
    ...
    },
    {
        ...
        "intro": "Boy names from the latest Australian top 100 that currently sit outside the top 50.",
    ...
    },
    {
        ...
        "intro": "Names with available meaning notes, paired with Australian ranking data so the list stays useful and factual.",
    ...
    },
    {
        ...
        "intro": "Names with nickname or longer-form information where it is available in the site metadata.",
...
def landing_reason(profile: dict[str, object], definition: dict[str, str]) -> str:
    ...
    if kind == "short":
        return f"{name} is {len(name)} letters long, so it fits the short-name brief cleanly."
    if kind == "outside_top_50":
        return f"{name} sits outside the current top 50 while still appearing in the latest Australian top 100."
    if kind in {"unique", "uncommon"}:
        return f"{name} is ranked lower in the current data, making it a more distinctive option than the top-list leaders."
    if kind == "rising" and movement:
        return f"{name} is moving up in the latest comparison, rising {movement.lower().replace('up ', '')}."
    if kind == "australian":
        return f"{name} appears in the Australian ranking data, so it is useful for parents comparing names used locally."
    if kind == "nature":
        if meaning and "uncertain" not in meaning.lower():
            return f"{name} fits the nature theme through its meaning: {phrase_list(meaning)}."
        return f"{name} works as an editorial nature or outdoors-style idea, with ranking data available for comparison."
    if kind == "vintage":
        if origin:
            return f"{name} has an established feel, with origin notes linked to {origin}."
        return f"{name} has an established style in the Australian ranking data."
    if kind == "cute":
        return f"{name} has a soft, friendly sound and a simple shape that suits a cute-name shortlist."
    if kind == "beautiful_meaning" and meaning:
        return f"{name} is included because its recorded meaning is {phrase_list(meaning)}."
    if kind == "nicknames":
        nicknames = str(meta.get("nicknames", "")) if isinstance(meta, dict) else ""
        root_name = str(meta.get("root_name", "")) if isinstance(meta, dict) else ""
        if nicknames:
            return f"{name} has nickname options in the available name notes: {phrase_list(nicknames)}."
        if root_name and root_name.lower() != name.lower():
            return f"{name} links back to the longer form {root_name} in the available name notes."
    return f"{name} fits this list and has Australian ranking data to compare."
        ...
        landing_page_html(
            {
                ...
                "intro": "Names that appear in the data but sit lower in the current rankings.",
        ...
        landing_page_html(
            {
                ...
                "intro": "Long-running names with an established feel in the Australian ranking data.",
